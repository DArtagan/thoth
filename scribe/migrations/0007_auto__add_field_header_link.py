...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Header.link'
        db.add_column('scribe_header', 'link',
                      self.gf('django.db.models.fields.URLField')(default='http://minesalumni.com', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Header.link'
        db.delete_column('scribe_header', 'link')
